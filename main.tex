...
%Enable better references including per-chapter bibloiographies
%\usepackage[sorting=none, refsection=chapter]{biblatex} % load the package
%\addbibresource{library.bib} % load the library

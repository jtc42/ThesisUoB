...
\input{./sections/background/NonlinearOptics}

\chapter{Experimental Techniques}\label{sec:techniques}
\input{./sections/techniques/NonlinearMeasurements}
...
\input{./sections/results/OAinPlanarNanohelices}\clearpage
\input{./sections/results/HRSinLiquidNanohelices}\clearpage
\input{./sections/results/EnantiomorphingChiralCrosses}\clearpage
\input{./sections/results/DiffractionInMicrostructures}\clearpage

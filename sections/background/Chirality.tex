...
\begin{equation}\label{eq:background:chirality:maxwell}
    \begin{split}
...
\begin{equation}\label{eq:background:chirality:tellegensSimplified}
    \begin{split}
        & \mathbf{D} = \varepsilon \mathbf{E} + i \gamma \mathbf{H} \\
        & \mathbf{B} = \mu \mathbf{H} - i \gamma \mathbf{E}
    \end{split}
\end{equation}

...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Experimentally, elliptical states of light are realised by making use of wave-plates. 
            \item Circularly polarised light is achieved by propagating linearly polarised light through a birefringent medium, one which has different refractive indices in orthogonal axes. Birefringence in the real part of refractive index means that components of light polarised along the orthogonal axes, known as the medium's fast and slow axes, propagate with different phase velocities and accumulate a relative phase shift during propagation. 
             \item By designing the thickness of the material such that the accumulated phase shift is $2n\pi \pm \pi/2$ at the operating wavelength $\lambda$ (where $n$ is some integer), elliptically polarised light can be obtained. Such a device is known as a quarter-wave plate, as it induces a shift of $\lambda/4$ between orthogonal polarisation components. The orientation of the elliptical profile depends on the direction of the incident polarisation, and the ellipticity depends on the angle of the material's fast axis relative to the direction of incident polarisation (figure~\ref{fig:QWP_in_out}).
            \item Similarly, the orientation of linear polarisation can be rotated (known as ``optical rotation'', OR) by making use of a half-wave plate, which induces a relative phase shift of $2n\pi \pm \pi$ between orthogonal polarisation components. The angle of optical rotation also depends on the angle of the material's fast axis relative to the direction of incident polarisation.
        \end{itemize}
    \end{itemize}
    \item The effect of wave plates demonstrates that an anisotropic structure can cause chiroptical effects (discussed further in section~\ref{sec:background:Chirality:anisotropy}): the direction of elliptically polarised light, and the angle of optical rotation, both reverse under a parity inversion, breaking mirror symmetry.

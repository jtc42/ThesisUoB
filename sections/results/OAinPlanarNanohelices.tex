...
\begin{itemize}
    \item Rewrite intro with reference to previous sections. Move references to those secions.
...
Sections of this chapter have been copied verbatum from the manuscript \textit{``Second Harmonic Generation Optical Rotation Solely Attributable to Chirality in Plasmonic Metasurfaces''}, Joel~T.~Collins et. al. \cite{Collins2018b}.
